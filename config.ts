...
export const config: Config = {
  ...
  defaultLatitude: '25.5941',
  defaultLongitude: '85.1376',
    ...
    [
      {
        ...
        links: [
          ...
          {
            name: 'Kwai',
            url: 'https://www.kuaishou.com/myFollow',
          },
        ],
      },
      {
        icon: 'clapperboard', // Icon for the list to use. The same as the buttons.
        links: [
          {
            name: 'NekoBT', // Display text for the link
            url: 'https://nekobt.to/', // URL to the page
          },
          {
            name: 'Subtitles',
            url: 'https://kitsunekko.net/dir1ist.php?dir=subtitles%2F',
          },
          {
            name: 'LiveChart',
